...
export default function CarouselPage() {
  return (
    <DocPage
      title="Carousel"
      description="A zero-JS carousel component using :has() + radio inputs. Slides are controlled by CSS state machine — no JavaScript required. Supports up to 6 slides."
      source="carousel.css"
      table={[
        { class: 'vel-carousel', properties: 'Root container — clips overflow, positions relative, applies border-radius' },
        { class: 'vel-carousel-track', properties: 'Flex row holding all slides — animated via translateX on :has() state' },
        { class: 'vel-carousel-slide', properties: 'Individual slide — min-width 100%, flex-shrink 0 to fill container' },
        { class: 'vel-carousel-dots', properties: 'Dot navigation bar — flex row centered below the track' },
        { class: 'vel-carousel-dot', properties: 'Label element targeting a radio input — acts as clickable dot indicator' },
        { class: 'vel-carousel-arrows', properties: 'Absolute overlay row for prev/next arrow labels — pointer-events managed' },
        { class: 'vel-carousel-prev', properties: 'Previous arrow label — circular button, backdrop blur, left side' },
        { class: 'vel-carousel-next', properties: 'Next arrow label — circular button, backdrop blur, right side' },
        { class: 'vel-carousel-img', properties: 'Modifier on vel-carousel — sets slides to relative for caption overlay' },
        { class: 'vel-carousel-caption', properties: 'Absolute overlay at slide bottom — gradient fade from black' },
        { class: 'vel-carousel-caption-title', properties: 'Bold heading text inside vel-carousel-caption' },
        { class: 'vel-carousel-caption-sub', properties: 'Muted subtitle text inside vel-carousel-caption' },
      ]}
      examples={[
        {
          label: 'Card content carousel',
  ...
  <div class="vel-carousel">
    ...
    <div class="vel-carousel-dots">
      ...
      <label class="vel-carousel-dot" for="vel-slide-3">3</label>
        ...
        {
          label: 'Image carousel with captions and arrows',
          html: `<div style="padding:24px;background:#060b17;border-radius:12px;font-family:system-ui,sans-serif;">
